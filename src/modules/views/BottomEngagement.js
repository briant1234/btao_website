...
function BottomEngagement(props) {
  ...
  return (
    <Container className={classes.root} component="section">
      ...
      <Typography variant="body1" gutterBottom={true}>
        Engagement sessions start at $800, and weddings start at $3500. Exact
        pricing for you and your needs will be personalized to you, so send me
        message so we can discuss. The rate for wedding is currently discounted
        as I build out my wedding portfolio. Book now to take advantage!
      </Typography>
